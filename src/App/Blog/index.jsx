  ...
  return (
    <>
      <div className="blog-post">
        ...
        <h1 className="blog-header">Why are we so nostalgic for the 1990s?</h1>
        ...
        <p className="rank">Senior Marketing specialist</p>
      </div>
      <div className="blog-post">
        <p className="blog-date">10-07-2023</p>
        ...
        <figcaption className="quote-author">Marilyn Monroe</figcaption>
        <p className="author">Radosław Majdan</p>
        <p className="rank">Senior Marketing specialist</p>
      </div>
      <div className="blog-post">
        <p className="blog-date">30-11-2022</p>
