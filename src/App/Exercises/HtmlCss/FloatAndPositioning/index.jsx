...
export function FloatAndPositioning() {
  return (
    <div>
      <div className="div1">
      ...
      <div className="div3">
        <img src={require('../../../Images/snow-wolf.png')} alt="snow-wolf" />
        <p>
          Lorem Ipsum is simply dummy text of the printing and typesetting
      ...
      <div className="div4_div1">ZOBACZ MEMY</div>
      ...
      <div className="div6">
        <div className="div6_div div_relative">
          <div className="div6_div div_absolute"></div>
          <div className="div6_div div_absolute"></div>
        </div>
      </div>
    </div>
