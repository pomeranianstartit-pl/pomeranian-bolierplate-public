...
export function ArrayRenderData() {
  const carData = [
  ...
  // band to caly obiekt tablicy powyzej
  ...
  return (
    <div>
      <h2>renderowanie listy z tablicy obiektow</h2>
      <ul>
        {carData.map((value) => (
          <li key={value.id}>{value.make}</li>
        ))}
      </ul>

      <h2>renderowanie tabeli z tablicy obiektow</h2>
