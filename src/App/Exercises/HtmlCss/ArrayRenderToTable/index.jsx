...
export function Exercise() {
  ...
  const bands = [
    ...
    { band: "Ramones", yearFormed: 1974, albums: 14, mostFamousSong: "Blitzkrieg Bop" },
  ...
  return <div className="array-render-to-table">
    ...
    <table>
      ...
      <tr>
        ...
        {Object.keys(bands[0]).map(function (key) {
          ...
          return <th key={key} onClick={() => setSortConfig(key)}>{camelCaseToNormalText(key)}</th>
