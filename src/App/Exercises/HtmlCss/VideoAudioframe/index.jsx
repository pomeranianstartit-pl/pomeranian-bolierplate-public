...
export function Exercise() {
  return (
    <div>
      ...
      {/* jesli nie chcemy aby bylo widoczne na stronie to usuway 'controls' jesli
      chcemy aby gralo samo to ustawiamy <audio autoplay></audio> , 
      a jesli w kolko to dodac - loop  */}
      <audio controls>
