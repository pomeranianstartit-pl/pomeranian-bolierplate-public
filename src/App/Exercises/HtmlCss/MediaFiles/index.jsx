...
export function MediaFiles() {
  return (
    <div className="mediaFiles">
      ...
      {/* iframe => sluzy do umieszczenia strony internetowej na danej stronie */}
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=YY5YAii_KJ1BEARg"
...
// dopisek 'control' uaktywnia przyciski sterujace do filmu
