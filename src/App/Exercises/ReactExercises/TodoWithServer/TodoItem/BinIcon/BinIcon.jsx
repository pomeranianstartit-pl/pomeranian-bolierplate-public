...
export function BinIcon({ isError }) {
  ...
  //   const isVariantDefined = Boolean(variant);
  //   const isVariantExist = Boolean(colors[variant]);
  //   const isVariantDefinedAndExist = isVariantDefined && isVariantExist;
  //   return isVariantDefinedAndExist ? colors[variant] : colors.normal;

  // return !variant ? colors.normal : colors[variant];
  //}

  //   const color = !variant ? colors.normal : colors[variant];
  return (
    <svg
