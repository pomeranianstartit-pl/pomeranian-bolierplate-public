...
const schema = yup.object({
  ...
  email: yup.string().email(schemaValidation.email).required(schemaValidation.required),
  ...
  isTermsChecked: yup.boolean(schemaValidation.boolean).oneOf([true], schemaValidation.booleanRequired),
  ...
  password: yup.string()
    ...
    .matches(/[0-9]/, schemaValidation.password.getCharacterValidationError("liczbę"))
    .matches(/[a-z]/, schemaValidation.password.getCharacterValidationError("małą litere"))
    .matches(/[A-Z]/, schemaValidation.password.getCharacterValidationError("dużą litere")),
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <div>
            ...
            <div>
              ...
              <span>paypal</span>
              <input value="transaction" type="radio" {...register("paymentMethod")} />
          ...
          <div>
            <label htmlFor="orderInformations">Opcje dodatkowe do zamówienia</label>
            <div>
              <input
        ...
        <div>
          <h2>Dane do realizacji zamówienia</h2>
            <div>
              ...
              <input id="name" type="name" placeholder="wpisz swoje imię i nazwisko" {...register("name")} />
              {errors.name?.message}
            ...
            <div>
              ...
              <input id="nickname" placeholder="wpisz swój pseudonim" {...register("nickname")} />
              {errors.nickname?.message}
            </div>

            <div>
              <label htmlFor="address">Adres do wysyłki*</label>
              <input id="address" type="address" placeholder="adres, na który mamy wysłać zamówienie" {...register("address")} />
              {errors.address?.message}
            </div>

            <div>
              <label htmlFor="email">Adres e-mail*</label>
              <input id="email" type="email" placeholder="jan.kowalski@gmail.com" {...register("email")} />
              {errors.email?.message}
            </div>

            <div>
              <label htmlFor="phone">Numer kontaktowy*</label>
              <input id="phone" type="tel" placeholder="888888888" {...register("phone")} />
              {errors.phone?.message}
            </div>

            <div>
              <label htmlFor="description">Dodatkowe uwagi do zamówienia</label>
              <textarea id="description" placeholder="jeśli masz jakieś uwagi, wpisz je tutaj..." {...register("description")} />
        ...
        <div>
          ...
          <div>
            ...
            <label htmlFor="createAccount">Chcę założyć konto razem z zamówieniem</label>
            {/* 
          ...
          <div>
            ...
            <input type="password" id="password" placeholder="wpisz hasło" {...register("password")} />
            {errors.password?.message}
          </div>

          <div>
            <label htmlFor="confirmPassword">Powtórz hasło</label>
            <input type="password" id="confirmPassword" placeholder="wpisz swoje hasło ponownie" {...register("confirmPassword")} />
        ...
        <div>
          ...
          <div>
            <label htmlFor="terms">Realizując zamówienie, akceptujesz regulamin naszego sklepu</label>
            <div>
              <input
                name='terms'
                type='checkbox'
          ...
          <div>
            <label htmlFor="newsletter">Dołącz do naszego newslettera z promocjami dla naszych klientów</label>
            <div>
              <input
                name='newsletter'
                type='checkbox'
