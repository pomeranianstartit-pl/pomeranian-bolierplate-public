export function IfStatements () {
    ...
    const conditionalIf = a > 10 ? console.log('Większe od 10'): console.log('Mniejsze lub równe 10')
    const extraConditionalIf = a > 10 ? console.log('Większe od 10'): console.log('Mniejsze lub równe 10')
    ...
    const result1 = iAmMen && 'Youre men';
