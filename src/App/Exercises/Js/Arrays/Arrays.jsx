...
export const Arrays = () => {
  ...
  function exampleArrayCopy() {
    ...
    const wynik = { kopia, tablica2, tablica3, tablica4, tablica5, tablica6 };
    return wynik;
  }
  ...
  function exampleArrayConcatenation() {
    ...
    const wynik = { jeden, dwa, jedenDwa };
  ...
  function exampleFilter() {
    ...
    const wynik = tablica.filter(function (element) {
  ...
  function exampleReduce() {
    ...
    function reduceFunction(pValue, cValue) {
      return pValue + cValue.lenght;
    }

    const wynik = tablica.reduce(reduceFunction, 0);
