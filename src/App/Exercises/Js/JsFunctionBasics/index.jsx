...
console.log('multiSumSumMore:', multiSumSumMore(2, 1, 1, 1, 2, 3));
console.log('multiSumSumMore:', multiSumSumMore(2, ...[1, 1, 1, 2, 3]));

// const multiSumSumNoArgs = () => {
...
console.log('mulitply:', multiplyAdd(2, 3, 0));
console.log('mulitply:', multiplyAdd(2, 2, 10));
...
//console.log(multi); nie czyta multi bo jest zdeklarowane między klamrami
