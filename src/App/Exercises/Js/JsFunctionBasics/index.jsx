...
export function JsFunctionBasics() {
  ...
  console.log(addWithTen);
  const result = addWithTen(5);
  console.log(outerFunction(10)(5));
  console.log(result);

  // --------------------------------------------------------------------
  // RECURSION / REKURENCJE - WYWOŁYWANIE FUNCJI W FUNKCJI (samego siebie)
  //
  ...
  let array1 = [1, 2, 3];
  let array2 = [4, 5, 6];
  let array = [...array1, ...array2, 7, 8, ...[9, 10]];
  console.log(array);
  console.log(...array1);
  // --------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------
  // HOISTING
  // Hoisting to zachowanie w JavaScript, w którym deklaracje zmiennych i funkcji są przenoszone
  //  na górę swojego zakresu, zanim kod zostanie wykonany.
  //   Oznacza to, że możemy używać zmiennych i funkcji przed ich faktyczną deklaracją
  //   w kodzie.
  // --------------------------------------------------------------------
