...
export function ExerciseJsArrayBasicsAndObjects () {
  ...
  const peopleFromGdansk = peopleData.filter((personBlaBla) => personBlaBla.adress === "Gdansk" &&  personBlaBla.age === 17);
  ...
  const peopleFromWAWA =peopleData.filter((newExample) => newExample.adress === "Warszawa" && newExample.age > 18);
  console.log("peopleFromWAWA", peopleFromWAWA);
  ...
  return (
    <div className="container--array-objects-basics">
      ...
      <br />
      <br />
      <div className= 'container--people-from-WAWA'>
        {
          peopleFromWAWA.map((peopleDataFromWAWA) => (
            <div className='container--people-data' key={peopleDataFromWAWA.id}>
              <div>Imie: {peopleDataFromWAWA.name}</div>
              <div>Wiek: {peopleDataFromWAWA.age}</div>
              <div>Adres: {peopleDataFromWAWA.adress}</div>
              <div>Id: {peopleDataFromWAWA.id}</div>
