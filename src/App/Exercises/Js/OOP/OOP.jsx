...
export function OOP() {
  ...
  let klaxon = new Klaxon();
  console.log(klaxon.beep());
  ...
  console.log(steeringWheel.turn('lewo'));
  console.log(steeringWheel.turn('prawo'));

  class GPS {
    navigate() {
      return ['turn right', 'turn left', 'drive straight'].sort(function () {
  ...
  class Car2 {
    ...
    turn(direction: string) {
      console.log(steeringWheel.turn(direction));
    }
    navigate() {
      console.log(gps.navigate());
    }
