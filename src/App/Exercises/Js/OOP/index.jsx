export const OOP = () => {
  ...
  //
  //
  //Zadanie 3: Zarządzanie bankowym kontem
  //Stwórz klasę BankAccount, która będzie zawierała informacje o numerze konta, saldzie
  //i metodach do wpłacania i wypłacania środków. Następnie stwórz kilka instancji tej klasy,
  //przetestuj działanie metod i zarządzaj stanem konta.
  //

  class BankAccount {
    constructor(numberAccount, money) {
      this.numberAccount = numberAccount;
      this.money = money;
    }
    moneyToCharge(charge) {
      return (this.money += charge);
    }
    moneyToPull(pull) {
      return (this.money -= pull);
    }
    show(text) {
      return console.log(`${text}: ${this.money}$`);
    }
  }
  const AdamAccount = new BankAccount(12345, 50);
  AdamAccount.show('Po utworzeniu');
  AdamAccount.moneyToCharge(33);
  AdamAccount.show('Po doładowaniu');
  AdamAccount.moneyToPull(40);
  AdamAccount.show('Po wypłaceniu');
  //
  //
  // Zadanie 4: Tworzenie katalogu filmów
  //Stwórz klasy Movie i MovieCatalog. Klasa Movie powinna zawierać informacje o tytule, reżyserze i roku produkcji filmu.
  // Klasa MovieCatalog powinna zawierać metodę dodawania filmów do katalogu
  // oraz metodę wyświetlania wszystkich filmów w katalogu.
  // class Movie {
  //   constructor(title, director, yearProduction) {
  //     this.title = title;
  //     this.director = director;
  //     this.yearProduction = yearProduction;
  //   }
  // }
  // class MovieCatalog extends Movie {
  //   const arrayMovies = []
