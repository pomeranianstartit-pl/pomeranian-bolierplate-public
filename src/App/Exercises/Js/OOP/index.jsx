...
export function Exercise() {
  ...
  //klasa engine start() => 'engine is turned on'   stop() => 'engine is turned off'
  //klasa klaxon   beep() => 'Beep!'
  //klasa SteeringWheel  turn(direction:string) => 'skręcamy w lewo/prawo'
  //klasa GPS  navigate() => wyprintuje nam losowo "turn right", "turn left", "drive straight"
  //stworz klase car, która posiada metody: start,stop,beep,turn,navigate
  //w klasie car powołuj metody poszczególnych części auta
  class Engine {
    start() {
  ...
  console.log(myCar1.start()); // "Engine is turned on"
  console.log(myCar1.stop()); // "Engine is turned off"
  console.log(myCar1.beep()); // "BEEEP!"
  console.log(myCar1.turn('left')); // "Turning left" (lub "right")
  console.log(myCar1.navigate()); // "turn right", "turn left" lub "drive straight"
