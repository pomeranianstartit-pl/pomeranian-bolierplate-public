export const Exercise = () => {
  ...
  const wynik = new Computer();
  console.log(wynik.getPrivate());
  console.log(wynik.add(1, 2));
  console.log(wynik.compute(5, 5, 5));
  console.log(wynik.introduce('Hej hi hello'));
  ...
  // Zadanie 1: Zarządzanie bankowym kontem

  // Stwórz klasę BankAccount, która będzie zawierała informacje o numerze konta,
  //  saldzie i metodach do wpłacania i wypłacania środków.
  // Następnie stwórz kilka instancji tej klasy, przetestuj działanie metod
  //  i zarządzaj stanem konta.
  return <div>OOP</div>;
};
